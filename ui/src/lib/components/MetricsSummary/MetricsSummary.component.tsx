...
import { Expand } from '../../../app/assets/icons';
...
export const Component = () => {
  ...
  const isThroughputMatch = Boolean(
    throughputSLO && interpolatedMetricData.throughput.enforcedPercentileValue >= throughputSLO
  );
    ...
    <>
      ...
      <MetricsSummaryContainer container>
        ...
        <MiddleColumn sx={{ paddingLeft: '0px !important' }} item xs={9}>
          <GraphContainer>
            <MetricLine
              data={[{ id: 'time per request', data: lineDataByRps.timePerRequest || [] }]}
        ...
        <FooterRightCell item xs={3}>
          <Typography variant="overline1" color="surface.onSurface" textTransform="uppercase">
            Maximum RPS per gpu
          </Typography>
